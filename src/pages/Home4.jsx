...
const Home4 = () => {
  return (
    <div className="py-24 px-8" style={{ backgroundColor: "#F2EDD1" }}>
      {/* Heading */}
      <h2 className="text-4xl font-extrabold text-center mb-16 text-[#4A2C63] font-serif">
        Why Raahi is the Smarter Choice for Every Ride You Take?
      </h2>

      {/* 3 Feature Boxes */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-20 text-center font-serif">
